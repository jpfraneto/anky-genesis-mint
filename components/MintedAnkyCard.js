  ...
  useEffect(() => {
    const fetchMetadata = async () => {
      const data = await fetch(
        `https://599b25aaf4ecdc0bd8bcb2dfc50000a9.ipfscdn.io/ipfs/${process.env.NEXT_PUBLIC_METADATA_IPFS_CID}/${tokenId}`
      );
  ...
  return (
    <div className="flex flex-col justify-around px-8 md:w-1/2 mx-auto mb-8">
      <div className=" mx-auto mb-4">
        <div className="relative w-96 aspect-square md:w-96 md:h-96 overflow-hidden rounded-xl mx-auto">
          <Image
            fill
      ...
      <div className=" text-gray-400 px-4 mt-2">
        ...
        <p>The first sojourn (96 day cycle) started on the 10th of Aug.</p>
